...
OWNER_ID = int(getenv("OWNER_ID", 6815918609))
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/8cd185b789502fe75c10e.jpg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://telegra.ph/file/a54caaf0a8f30be54e4f8.jpg"
)
